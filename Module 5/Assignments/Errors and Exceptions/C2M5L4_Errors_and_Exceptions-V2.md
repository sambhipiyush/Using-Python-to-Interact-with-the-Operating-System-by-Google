...
```
    ...
    <ipython-input-3-17c39a180301> in <module>
          6     return my_list
          7 
    ----> 8 print(RemoveValue(27))
    

    <ipython-input-3-17c39a180301> in RemoveValue(myVal)
...
```
    ...
    <ipython-input-8-6539467791a2> in <module>
          5     return myList
          6 
    ----> 7 print(OrganizeList(my_new_list))
    

    <ipython-input-8-6539467791a2> in OrganizeList(myList)
